...
void main() {
  testWidgets('RecommendationsScreen renders AI recommendations header and cards', (tester) async {
    final mockRecs = [
      Recommendation(
        id: 'rec_1',
        userId: 'u1',
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          recommendationsProvider.overrideWithValue(mockRecs),
        ],
        child: MaterialApp(
    ...
    expect(find.text('Ask AI Tutor Tricky Viva & Exam Questions'), findsOneWidget);
    expect(find.text('Generate Exam-Focus Revision Summaries'), findsOneWidget);
  });
}
