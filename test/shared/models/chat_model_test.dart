...
void main() {
  group('ExplanationMode Tests', () {
    test('ExplanationMode.fromId returns correct enum value', () {
      expect(ExplanationMode.fromId('beginner'), equals(ExplanationMode.beginner));
      expect(ExplanationMode.fromId('Student'), equals(ExplanationMode.student));
      ...
      expect(ExplanationMode.fromId('unknown'), equals(ExplanationMode.student));
    });
